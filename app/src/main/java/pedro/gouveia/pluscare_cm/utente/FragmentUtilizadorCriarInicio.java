...
public class FragmentUtilizadorCriarInicio extends Fragment {
        ...
        buttonCreate.setOnClickListener(view -> {
            if(userNames.contains(username.getText())){
                ...
                if (verifyPassword.getText().equals(password.getText())) {
                    new Utilizador(email.getText().toString(), password.getText().toString(), username.getText().toString(), createAddress.getText().toString());
